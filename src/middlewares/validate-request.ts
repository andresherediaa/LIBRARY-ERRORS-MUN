...
export const validateRequest = (
  ...
  if (!errors.isEmpty()) {
    ...
    const typeMsg = msg.typeMsg ? msg.typeMsg : ErrorCategories.SINTAX;
    const userMsg = msg.userMsg ? msg.userMsg : ErrorController.getErrorMessage(ErrorCategories.SINTAX);
