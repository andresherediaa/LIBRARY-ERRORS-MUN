...
export const errorCodes: { [key: string]: string } = {
    ...
    "203": "Error al llenar informacion de las facturas, contactar con el departamento de sistemas municipal",
    ...
    "212": "No es posible procesar la consulta: El identificador proporcionado es invalido o no existe un cliente asociado.",
    "213": "No se puede realizar la anulacion: las cartas no fueron cobradas hoy o aun no han sido cobradas.",
