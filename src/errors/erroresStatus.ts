...
export const errorCodes: { [key: string]: string } = {
 ...
 "E003": "El usuario o placa tiene titulos de crédito pendientes, debe realizar el tramite en las oficinas de la EMOV EP en Tesoreria",
 ...
 "E009": "Revisar el valor que se envia en el numero de transacción",
 ...
 "E049": "Revisar que la recaudacion se realizó el mismo dia en el que se solicita el reverso",
 "E050": "No hay rubros a reversar",
 "E051": "Vehiculo ya salió del CRV no es posible reversar la transaccion",
 ...
 "ERRING": "Transacción no puede comprobar registro porque existió un error en la transaccion al ingreso",
 "NOTC": "Transacción no puede ser comprobada porque existe pendiente de comprobación una nota de credito",
 ...
 "BANE": "El pago ya se registró como pagado por Banca Electronica",
